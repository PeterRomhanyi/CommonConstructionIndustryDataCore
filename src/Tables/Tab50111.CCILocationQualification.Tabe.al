...
table 50111 "CCI Location Qualification"
{
    Access = Public;
    Caption = 'Location Qualification', Comment = 'HUN: Telephely képesítés';
    DataCaptionFields = "Location No.";
    ...
    fields
    {
        ...
        {
            Caption = 'Location No.', Comment = 'HUN: Telephely szám';
            DataClassification = CustomerContent;
            NotBlank = true;
        ...
        field(3; "Qualification Code"; Code[10])
        {
            ...
            DataClassification = CustomerContent;
            TableRelation = "CCI Location Writings"."Code";

            trigger OnValidate()
            var
                LocationWritings: Record "CCI Location Writings";
            begin
                LocationWritings.Get(Rec."Qualification Code");
                Rec.Description := LocationWritings.Description;
            end;
        }
        ...
        field(11; "Location Status"; Enum "CCI Resource Status")
        {
            Caption = 'Location Status', Comment = 'HUN: Telephely állapot';
            DataClassification = CustomerContent;
            Editable = false;
        }
        field(12; Comment; Boolean)
        {
            CalcFormula = exist("Human Resource Comment Line" where("Table Name" = const("Location Qualification"),
                                                                     "No." = field("Location No."),
    ...
    trigger OnDelete()
    var
        DeleteErr: Label 'You cannot delete location qualification information if there are comments associated with it.', Comment = 'HUN: Nem törölheti a telephely képesítési adatokat, ha megjegyzések kapcsolódnak hozzá.';
    begin
